...
for m = 1:N
    for s = 1:S_max
        ...
        for i = 1:1000
            ...
            x_approx_sm = OMP(y_sm,A,norm(n_sm));
            x_approx_lg = OMP(y_lg,A,norm(n_lg));
...
figure(1)
imagesc(success_prob_sm_20/1000);
ax = gca;
ax.YDir = 'normal';
...
figure(2)
imagesc(success_prob_lg_20/1000);
ax = gca;
ax.YDir = 'normal';
title(['The Noiseless Phase Transition of The Probability ' ...
...
figure(5)
imagesc(success_prob_sm_50/500);
ax = gca;
ax.YDir = 'normal';
title(['The Noiseless Phase Transition of The Probability ' ...
    'of Exact Support Recovery, N = 50, std = 0.01']);
xlabel('S_{max}');
ylabel('Measuremnt M');
colorbar

figure(6)
imagesc(success_prob_lg_50/500);
ax = gca;
ax.YDir = 'normal';
title(['The Noiseless Phase Transition of The Probability ' ...
...
%%
figure(9)
imagesc(success_prob_sm_100/2000);
ax = gca;
ax.YDir = 'normal';
title(['The Noiseless Phase Transition of The Probability ' ...
...
figure(10)
imagesc(success_prob_lg_100/2000);
ax = gca;
ax.YDir = 'normal';
title(['The Noiseless Phase Transition of The Probability ' ...
